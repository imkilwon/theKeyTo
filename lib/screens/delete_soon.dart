...
class CoverLetterScreen_ extends StatefulWidget {
  const CoverLetterScreen_({Key? key}) : super(key: key);

  @override
  State<CoverLetterScreen_> createState() => _CoverLetterScreen_State();
}

class _CoverLetterScreen_State extends State<CoverLetterScreen_> {
  @override
