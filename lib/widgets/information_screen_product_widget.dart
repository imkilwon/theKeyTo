...
class InformationScreenProductWidget extends StatefulWidget {
  final ProductModel productModel;
  final bool favorite;

  const InformationScreenProductWidget({
    Key? key,
  ...
  @override
  State<InformationScreenProductWidget> createState() => _InformationScreenProductWidgetState();
}

class _InformationScreenProductWidgetState extends State<InformationScreenProductWidget> {
